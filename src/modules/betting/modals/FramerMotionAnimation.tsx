...
const FramerMotionAnimation = () => {
  return (
    <TreasureCont style={{ position: "absolute", right: "0%", top: "-50%" }}>
      <img className="treasureBox" src={OpenTreasureBox} alt="coins" />
      ...
      <CoinImg
        animate={{
          ...
          opacity: [0, 1, 0],
          y: [
            0, -5, -10, -15, -20, -25, -30, -35, -40, -45, -50, -55, -60, -65, -70, -75, -80, -75, -70, -65,
            -60, -55, -50, -45, -40, -35, -30, -25, -20, -15, -5, 0, 5, 10,
          ],
        }}
        transition={{
          duration: 2,
      ...
      <CoinImg
        animate={{
          ...
          x: [0, -35, -70],
          y: [
            0, -5, -10, -15, -20, -25, -30, -35, -40, -45, -50, -55, -60, -60, -55, -50, -45, -40, -35, -30,
            -25, -20, -15, -5, 0,
          ],
        }}
        transition={{
