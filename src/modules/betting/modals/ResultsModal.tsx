...
const ResultsModal = (props: any) => {
    ...
    return (
        <ModalBody
            ...
            style={{ ...styles }}
        >
            <Box style={{ width: '600px', height: '550px', padding: "20px", background: "#2A1966", display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexDirection: 'column', position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)' }}>
